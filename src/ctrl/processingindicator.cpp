...
ProcessingIndicator::ProcessingIndicator(QWidget *parent) :
    QWidget(parent)
{
...
void ProcessingIndicator::initVariables()
{
    m_nCurrentIndex=0;
...
void ProcessingIndicator::paintEvent(QPaintEvent *)
{
    QPainter painter;
    painter.begin(this);
...
void ProcessingIndicator::drawBackground(QPainter *painter)
{
    painter->save();
...
void ProcessingIndicator::drawRects(QPainter *painter)
{
    painter->save();
...
void ProcessingIndicator::UpdateGraph()
{
    if(!m_bReverse)
    {
...
void ProcessingIndicator::start()
{
    updateTimer->start();
}

void ProcessingIndicator::stop()
{
    updateTimer->stop();
}

void ProcessingIndicator::setInterval(int msec)
{
